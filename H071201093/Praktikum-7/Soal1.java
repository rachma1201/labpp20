...
public class Soal1 {
    public static void main(String[] args) {
        ...
        while(cek.equalsIgnoreCase("Y")){
            ...
            String input = rhm.next();
        if(input.equalsIgnoreCase("d")){
            int nomorFilm = rhm.nextInt() - 1;
            detailFilm(nomorFilm,movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = rhm.next();
        }
        else if(input.equalsIgnoreCase("a")){
            addFilm(movieFavourite,rhm);
            daftarFilm(movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = rhm.next();
        }
        else if(input.equalsIgnoreCase("r")){
            int deleteNumberOfFilm = rhm.nextInt() - 1;
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> movieFavourite, Scanner rhm2){
        rhm2.nextLine();
        String judul;   String rilis;   String durasi;
        String genre;   String sinopsis;    String cast;

        System.out.println("Judul:"); judul = rhm2.nextLine();
        System.out.println("Rilis:"); rilis = rhm2.nextLine(); 
        System.out.println("Durasi:"); durasi = rhm2.nextLine();
        System.out.println("Genre:"); genre = rhm2.nextLine();
        System.out.println("Sinopsis:"); sinopsis = rhm2.nextLine();
        System.out.println("Cast:"); cast = rhm2.nextLine();
